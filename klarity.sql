...
--
-- Host: localhost
-- Generation Time: Sep 22, 2015 at 01:59 am
...
(2, 'Rugby', '2015-09-21 02:05:54', NULL, NULL),
...
(2, 2, 2, '2015-09-21 02:06:08', NULL, NULL),
(3, 3, 3, '2015-09-21 02:08:45', NULL, NULL),
(4, 4, 4, '2015-09-21 02:10:29', NULL, NULL),
(5, 4, 4, '2015-09-21 02:10:32', NULL, NULL);
...
INSERT INTO `users` (`id`, `email`, `password`, `firstname`, `lastname`, `role`, `avarta`, `created_at`, `updated_at`, `deleted_at`, `remember_tokken`) VALUES
(1, 'marry.smith@mail.com', '1', 'Marry', 'Smith', 0, 'hello.jpg', '2015-09-21 01:09:44', NULL, NULL, ''),
(2, 'peter.pan@mail.com', '1', 'peter', 'pan', 0, 'hello.jpg', '2015-09-21 01:09:46', NULL, NULL, ''),
(3, 'martin.cho@mail.com', '1', 'Martin', 'Cho', 1, 'hello.jpg', '2015-09-21 02:14:51', NULL, NULL, '');
